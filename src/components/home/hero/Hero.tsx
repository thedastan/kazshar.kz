	...
	return (
		<>
			<div className="relative w-[100%] h-[700px] md:h-[100vh]">
				...
				<div className="flex px-[20px] sm:px-16 bg-[#000000b0] gap-20 absolute top-0 left-0 w-[100%] h-[700px] md:h-[100vh] justify-end items-start flex-col">
					<div className="">
				...
				{modal && (
					<div
						...
						<div
							...
							<video autoPlay controls className="w-full rounded-lg mt-10 md:mt-4">
								<source src="/metal.mp4" type="video/mp4" />
