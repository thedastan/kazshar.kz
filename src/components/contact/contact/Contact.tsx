      ...
      <div className="flex flex-col md:flex-row   md:items-none h-full md:h-[100vh]">
        <div className="bg-[rgb(199,18,18)] h-[700px] md:h-[100vh] px-[20px]  w-[100%] md:w-[700px] flex flex-col items-center">
          ...
          <div className="flex max-w-[300px] w-full">
            ...
            <button
              className={`px-4 h-[40px] transition ${
                tab === "contact"
                  ? "bg-[#fff] text-[#c71212] font-[600]  mt-2 w-full border-[1px] border-white"
                  : "bg-[#c71212] text-white  mt-2 w-full border-[1px] border-white"
              }`}
          ...
          <div className="">
            {tab === "form" ? (
              <div className="">
                ...
                <div className="flex items-center justify-center flex-col gap-1 max-w-[350px] w-full  mt-[30px]">
              ...
              <div className="mt-[40px]">
                <div className="flex items-start justify-center flex-col mt-2 gap-4 max-w-[280px] w-full">
